...
function rateBox(heading, paragraph, accent = "electric-blue") {
  return {
    kind: "rate",
    payload: {
      heading,
...
const ROUTE_DEFAULTS = {
  ...
  "/member-pages": [
    rateBox(
      ...
      "Each page can highlight instruments, styles, audio, video, and how to book you — powered by members who register and maintain their own story.",
      "cyan"
    ),
    bformsBox(
      "Password-protected roster",
      "The full membership directory stays private. For access help, call the union hall — dial 0 for the operator.",
      "Members-only directory info →",
