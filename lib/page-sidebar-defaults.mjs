...
const ROUTE_DEFAULTS = {
  "/news-and-events": [
    richSidebarBox(
      ...
      { accentColor: "cyan", styleName: "glass-panel", layoutName: "standard" }
    ),
    richSidebarBox(
      "contact",
      "Call the union hall",
      ...
      { accentColor: "gold", styleName: "soft-panel", layoutName: "compact" }
    ),
    richSidebarBox(
      "contact",
      ...
      { accentColor: "electric-blue", styleName: "glass-panel", layoutName: "standard" }
    ),
    richSidebarBox(
      "bforms",
      ...
      { accentColor: "deep-blue", styleName: "glass-panel", layoutName: "feature" }
    ),
    richSidebarBox(
      "bforms",
      "Accent link pair",
      ...
      { accentColor: "cyan", styleName: "soft-panel", layoutName: "standard" }
    ),
    richSidebarBox(
      "cta_group",
      "CTA cards (stacked)",
      ...
      { accentColor: "coral", styleName: "glass-panel", layoutName: "feature" }
    ),
    richSidebarBox(
      "rate",
      "Compact + bare shell",
    ...
    richSidebarBox(
      ...
      { accentColor: "deep-blue", styleName: "soft-panel", layoutName: "compact" }
    ),
    officeContact(
