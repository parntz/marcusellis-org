...
export const DEFAULT_RECORDING_PAGE_CONTENT = Object.freeze({
  ...
  showMemberNotices: true,
  showSidebarCtas: true,
});
...
function normalize(input, defaults = DEFAULT_RECORDING_PAGE_CONTENT) {
  ...
  return {
    ...
    showMemberNotices: valueOrFallback(parsed, "showMemberNotices", defaults.showMemberNotices) !== false,
    showSidebarCtas: valueOrFallback(parsed, "showSidebarCtas", defaults.showSidebarCtas) !== false,
  };
}
