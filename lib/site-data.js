export const primaryNav = [
  ...
  },
  {
    ...
    children: [
      { label: "Sound Healthcare & Financial", href: "http://soundhealthcare.org", newWindow: true },
      {
        label: "The Tennessee Credit Union",
        href: "/_downloaded/sites/default/files/Media%20Root/300210%20TTCU%20Look%20Services_MAIN.pdf",
        newWindow: true,
      },
      { label: "AFM Pension Info", href: "http://afm-epf.org", newWindow: true },
      { label: "Free Rehearsal Hall", href: "/free-rehearsal-hall" },
      {
        label: "Instrument Insurance",
      ...
      {
        label: "Other AFM 257 Discounts",
        href: "/benefits-union-members",
        newWindow: true,
        children: [{ label: "Union Plus Program", href: "/union-plus-program", newWindow: true }],
      },
  ...
  },
  {
    ...
    href: "/media",
    children: [
      { label: "Featured Video", href: "/featured-video" },
